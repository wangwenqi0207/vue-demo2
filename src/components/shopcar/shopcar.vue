          ...
          productList: [
            {
              ...
              'pro_num': 3,//数量
              'pro_img': require('../../assets/img/testimg.jpg'),//图片链接
              'pro_price': 800//单价
            },
            {
              'pro_name': '【斯文】甘油 | 丙三醇',//产品名称
...
<style scoped>
  ...
  .page-shopping-cart .check-span {
    ...
    width: 24px;
    height: 20px;
    background: url("../../assets/img/shopping_cart.jpg") no-repeat 0 0;
  }

  .page-shopping-cart .check-span.check-true {
    background: url("../../assets/img/shopping_cart.jpg") no-repeat 0 -22px;
  }
  ...
  .page-shopping-cart .cart-product table .product-num .num-reduce span {
    background: url("../../assets/img/shopping_cart.jpg") no-repeat -40px -22px;
    display: block;
    width: 6px;
    height: 2px;
  ...
  .page-shopping-cart .cart-product table .product-num .num-add span {
    background: url("../../assets/img/shopping_cart.jpg") no-repeat -60px -22px;
    display: block;
    width: 8px;
    height: 8px;
  ...
  .page-shopping-cart .cart-product-info .delect-product span {
    ...
    width: 13px;
    height: 15px;
    background: url("../../assets/img/shopping_cart.jpg") no-repeat -60px 0;
  }
  ...
  .page-shopping-cart .cart-product-info .keep-shopping span {
    ...
    width: 15px;
    height: 15px;
    background: url("../../assets/img/shopping_cart.jpg") no-repeat -40px 0;
  }
  ...
  .page-shopping-cart .cart-worder .choose-worder span {
    ...
    width: 22px;
    height: 22px;
    background: url("../../assets/img/shopping_cart.jpg") no-repeat -92px 0;
  }
  ...
  .choose-worker-box .box-title a {
    ...
    width: 10px;
    height: 10px;
    background: url("../../assets/img/shopping_cart.jpg") no-repeat -80px 0;
  }

  .choose-worker-box .box-title a:hover {
    background: url("../../assets/img/shopping_cart.jpg") no-repeat -80px -22px;
  }
