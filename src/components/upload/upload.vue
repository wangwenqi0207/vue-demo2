    ...
    <div class="hello">
      ...
      <div class="K-cobe">
        <div class="perspective">
          ...
          <input class="K-puts" type="radio" name="tabs" id="tab-top">
          <input class="K-puts" type="radio" name="tabs" id="tab-front">
          <input class="K-puts" type="radio" name="tabs" id="tab-bottom">
